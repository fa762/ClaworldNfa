...
const ASSET_PATHS: Record<string, string> = {
  ...
  'npc-sable': resolve(process.cwd(), '..', 'art', 'sources', 'npc_sable_v1.png'),
  'sable-portrait-default': resolve(process.cwd(), '..', 'art', 'sources', 'sable_portrait_default_v1.png'),
  'sable-portrait-calm': resolve(process.cwd(), '..', 'art', 'sources', 'sable_portrait_calm_v1.png'),
  'sable-portrait-warning': resolve(process.cwd(), '..', 'art', 'sources', 'sable_portrait_warning_v1.png'),
  'sable-portrait-secret': resolve(process.cwd(), '..', 'art', 'sources', 'sable_portrait_secret_v1.png'),
