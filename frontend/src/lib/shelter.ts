...
export const SHELTER_SPECIALTIES: Record<number, ShelterSpecialty> = {
  ...
  3: { zh: '币安中继塔最活跃', en: 'Binance relay hub active', focus: 'market', color: '#ffd34d', marketHintZh: '这里的撮合墙会同步 BSC 中继链路上的价格、盘口和清算回执。', marketHintEn: 'The match wall here mirrors prices, order flow, and settlement receipts from the BSC relay path.' },
  ...
  6: { zh: '黑市报价最失真', en: 'Black market quotes distort here', focus: 'market', color: '#ffaa55', marketHintZh: '这里更容易看到假桥、冷钱包残骸和高风险拍卖。', marketHintEn: 'This is where fake bridges, lost cold wallets, and high-risk auctions are most visible.' },
